<?php
	...
	$menu = array_merge($menu, array(array('Mon compte', '', 'user', 'nav-hide-on-mobile')));
	
	if (!is_logged_in($this)) {
		$menu = array_merge($menu, array(array("S'enregistrer", site_url("auth/register"), '', 'nav-hide-on-mobile')));
		$menu = array_merge($menu, array(array("Se connecter", site_url("auth/login"), '', 'nav-hide-on-mobile')));
	} else {
		...
		, array("Mes parties", site_url("game/mine"), '', 'nav-hide-on-mobile')));
		...
		$menu = array_merge($menu, array(array("Se déconnecter", site_url("auth/logout"), '', 'nav-hide-on-mobile')));
