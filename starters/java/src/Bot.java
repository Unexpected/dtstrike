...
public abstract class Bot extends AbstractSystemInputParser {
	 ...
	 */
	@Override
	public void addFleet(int owner, int numShips, int sourceDept, int destDept,
			int tripLength, int turnsRemaining, boolean military) {
		if (military) {
			game.addFleet(new MilitaryFleet(owner, numShips, sourceDept,
					destDept, tripLength, turnsRemaining));
		} else {
			game.addFleet(new EconomicFleet(owner, numShips, sourceDept,
					destDept, tripLength, turnsRemaining));
		}
	}
	 ...
	 */
	@Override
	public void addMilitaryPlanet(int id, int owner, int numShips, double x,
			double y) {
	 ...
	 */
	@Override
	public void addEconomicPlanet(int id, int owner, int numShips, int revenue,
			double x, double y) {
