...
public class Game {
	...
	public Game(int loadTime, int turnTime, int turns) {
	 ...
	 * Planets are numbered starting with 0.
	 * 
	...
	/**
	 * Returns the planet with the given planet_id
	 * They are numbered starting at 0. There are NumPlanets() planets.
	 * <b>planet_id's ARE consistent from one turn to the next.</b>
	 * 
	...
	/**
	 * Returns the fleet with the given fleet_id. 
	 * Fleets are numbered starting with 0. There are numFleets() fleets.
	 * <b>fleet_id's are not consistent from one turn to the next.</b>
	 * 
	...
	/**
	 * Return a list of all the military planets owned by the targeted rival player.
	 * 
	 * @param playerID player id (> 1)
	 * @return the planet list
	 */
	...
	/**
	 * Returns the number of ships that the targeted player has, either located on planets or in flight.
	 * 
	 ...
	 * 
	 * @param sourcePlanet the ID of the source planet
	 * @param destinationPlanet the ID of the destination planet
	 * @return the distance
	 */
	 ...
	 * <b>If you break this rule, the game engine kicks your bot out of the game instantly.</b></li>
	 ...
	 * @param source the instance of the source planet
	 * @param dest the instance of the destination planet
	 * @param numShips the number of ships to send
	 */
